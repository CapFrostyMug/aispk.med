<div class="row mb-4 faculty-block-child display-none">
    <div class="col-6">
        ...
        <div class="form-check">
            <input id="" type="hidden" name="originalDocs" value="0">
            <input id="original-docs-1" class="form-check-input parent-checkbox" name="originalDocs" value="1"
                   type="checkbox"
