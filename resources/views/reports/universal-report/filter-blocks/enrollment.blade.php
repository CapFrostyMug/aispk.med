<div class="accordion-item">
    ...
    <div id="collapseEnrollment" class="accordion-collapse collapse"
         aria-labelledby="headingEnrollment">
        <div class="accordion-body p-3">
            <div class="form-check">
                <input id="faculty-admitted-1" class="form-check-input" name="faculties[name]"
                       value="Зачислен на специальность" type="checkbox"
                       @if (isset(request()->input('faculties')['name'])) checked @endif>
            ...
            <div class="form-check">
                <input id="decree-1" class="form-check-input" name="decrees[name]" value="Номер приказа" type="checkbox"
                       @if (isset(request()->input('decrees')['name'])) checked @endif>
                <label for="decree-1" class="form-check-label">Номер приказа</label>
            </div>
            <div class="form-check">
                <input id="pickup-docs-1" class="form-check-input" name="enrollment[is_pickup_docs]"
                       value="Отметка о возврате документов" type="checkbox"
                       @if (isset(request()->input('enrollment')['is_pickup_docs'])) checked @endif>
